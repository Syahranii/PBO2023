...
def hitung_luas():
    ...
    txtluas_balok.insert(END,luas_balok)
...
# Output Label Luas
luas_balok = Label(frame, text="Luas: ") 
luas_balok.grid(row=5, column=0, sticky=W, padx=5, pady=5)
...
txtluas_balok.grid(row=5, column=1, sticky=W, padx=5, pady=5)
