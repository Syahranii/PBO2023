...
class Translate:
    ...
    def aturKomponen(self):
        ...
        # pasang textbox
        self.txtSumber = Entry(mainFrame, width=100)
        self.txtSumber.grid(row=0, column=1, columnspan=3, padx=5, pady=5)

        self.txtHasil = Entry(mainFrame, width=100)
        self.txtHasil.grid(row=2, column=1, columnspan=3, padx=5, pady=5)

        # Pasang Button
        self.btnTranslateEn = Button(mainFrame, text='Translate to Hindi',
            command=lambda: self.onTranslate('hi'))
        self.btnTranslateEn.grid(row=1, column=0, padx=5, pady=5)

        self.btnTranslateNl = Button(mainFrame, text='Translate to spanish',
            command=lambda: self.onTranslate('es'))
        self.btnTranslateNl.grid(row=1, column=1, padx=5, pady=5)

        self.btnTranslateCn = Button(mainFrame, text='Translate to japanese',
            command=lambda: self.onTranslate('ja'))
        self.btnTranslateCn.grid(row=1, column=2, padx=5, pady=5)

        self.btnTranslateAr = Button(mainFrame, text='Translate to korean',
